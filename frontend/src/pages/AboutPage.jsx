    ...
    <div className="about-page-detailed">
      ...
      <section className="about-hero" style={{ 
        ...
        <div className="container" style={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
          ...
          >
            <h1 className="serif" style={{ fontSize: 'var(--font-hero)', color: 'white', marginBottom: '1.5rem' }}>Driven by <span className="highlight">Trust.</span></h1>
      ...
      <section style={{ padding: '10rem 0' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8rem', alignItems: 'center' }}>
          <div>
            ...
            <h2 className="serif" style={{ fontSize: 'var(--font-xl)', margin: '2rem 0' }}>Redefining <span className="highlight">Real Estate</span> in Chennai</h2>
          ...
          <div style={{ position: 'relative' }}>
             ...
             />
             <div style={{ position: 'absolute', bottom: '-40px', right: '-40px', background: 'var(--accent-gold)', padding: '2rem', borderRadius: '20px', color: 'var(--primary-dark)', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }}>
      ...
      <section style={{ padding: '8rem 0', background: 'var(--primary-dark)', color: 'white' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '4rem', textAlign: 'center' }}>
            {stats.map((stat, i) => (
              <div key={i}>
                <h3 className="serif" style={{ fontSize: 'var(--font-xl)', color: 'var(--accent-gold)', marginBottom: '1rem' }}>{stat.num}</h3>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem' }}>
            ...
            >
               ...
               <h3 className="serif" style={{ fontSize: 'var(--font-lg)', marginBottom: '1.5rem' }}>Our <span className="highlight">Vision</span></h3>
               <p style={{ color: 'var(--text-light)', fontSize: '1.1rem', lineHeight: 1.8 }}>
            ...
            >
               ...
               <h3 className="serif" style={{ fontSize: 'var(--font-lg)', marginBottom: '1.5rem' }}>Our <span className="highlight">Mission</span></h3>
               <p style={{ color: 'var(--text-label)', fontSize: '1.1rem', lineHeight: 1.8 }}>
      ...
      <section style={{ padding: '8rem 0', background: 'var(--accent-gold)', textAlign: 'center' }}>
        <div className="container">
          <h2 className="serif" style={{ fontSize: 'var(--font-lg)', color: 'var(--primary-dark)', marginBottom: '2.5rem' }}>Want to know more about our journey?</h2>
